package net.mcreator.bloodskellyvillage;
...
@Mod("bloodskellyvillage")
public class BloodskellyvillageMod {
	public static final Logger LOGGER = LogManager.getLogger(BloodskellyvillageMod.class);
	public static final String MODID = "bloodskellyvillage";

	public BloodskellyvillageMod(IEventBus modEventBus) {
